...
- Lays down all upstream-managed files (`CLAUDE.md`,
  ...
  `Cleanup-Worktree.ps1`, `Consolidate-Specs.ps1`, `Start-IssueAgent.ps1` and
  their `*.Tests.ps1`, plus the `start-issue-agent.sh` entry point).
