...
Recording a site's traffic and discovering its API (`web-api-discovery`) now
lives in its own repository and installs for any agent:
https://github.com/IntelliTect-Samples/web-api-discovery.
