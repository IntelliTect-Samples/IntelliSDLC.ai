...
You are the instructions maintenance agent for the **Gmail Synthesizer** project.
...
- [ ] **Terminology consistent** (e.g., "Gmail Synthesizer" everywhere, not "GoogleRecorderClient")
