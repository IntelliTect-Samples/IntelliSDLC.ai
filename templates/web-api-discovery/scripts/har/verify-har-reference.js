...
// punctuation count.
// The wire-grammar recognisers moved to har-body-grammar.js (#429).
// har-catalogue.js needs the same answer to count `RequestBodies`, and a
// library importing a predicate from a command-line tool is a dependency
// pointing the wrong way. The reasoning for each recogniser, and the
// measurements behind it, moved with the code.
const bodyGrammar = require(path.join(__dirname, 'har-body-grammar.js'));
const { bodyCarriesPayloadStructure } = bodyGrammar;
